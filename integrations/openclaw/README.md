...
This package replaces the OpenClaw entry in the former combined `@agentscope-ai/reme` package. Remove the old plugin
before installing this host-specific package.
